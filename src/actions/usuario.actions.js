        ...
        loginApi(username, password)
            .then(
                user => {
                    ...
                    } else if (user.Intentos >= 3 && user.IdEstadoUsuario === estadoUsuarioConstants.BLOQUEADO) {
    ...
    return fetch(`${urlApi}`, requestOptions)
        ...
        .then(user => {
            ...
            if (user.access_token) {
                ...
                return axios.post(apiGatewayEndpointPath, obj, { headers: { Authorization: `Bearer ${user.access_token}`, Endpoint: '/ApiUsuarios/E-Cert-CrediAutos/LogIn', APIKey: "configConstants.API_USUARIOS_KEY" } }) //GetByUsername
                    .then((response) => {
                        ...
                        user.FullName = response.data.User.Nombres + ' ' + response.data.User.Apellidos
